    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-y-5">
            ...
            {success ? 
                ...
                <Button className={`bg-black font-semibold rounded-lg text-white h-10  cursor-pointer transition-all ${isSubmitting ? "opacity-50" : ""}`} onClick={() => handleSubmit()} >Pre-registrarse {isSubmitting ?  <img src="universal/spinner.svg" width="25" className=" animate-spin"/>  : ""} </Button>
              }
