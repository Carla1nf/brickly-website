...
export default function InvestPage() {
  ...
  return (
    <>
          {isChecking ? <DetailsBeforeCheckout /> :
    ...
    <div className="flex flex-col xl:-ml-10 -mt-10">
      ...
      <div className="max-w-9xl py-5 px-20 flex gap-5 relative ">
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="xl:w-[780px]">GTHolaSOLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
            ...
            <div className="flex w-full flex-col gap-5">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex flex-col justify-center ">
                  ...
                  <div className="text-sm text-neutral-500 min-w-min">Hotelier Services LLC</div>
                </div>
                <div className="justify-self-end w-7/12 flex justify-end gap-5 items-center">
                  <div className="bg-black h-10 w-32 bg-brickly400/30 rounded flex justify-center text-brickly700 font-semibold items-center text-sm">Página web</div>
                  <div className="bg-black h-10 w-32 bg-brickly400/30 rounded flex justify-center text-brickly700 font-semibold items-center text-sm">Proyectos</div>
                </div>
              </div>
            </div>
        ...
        <div className=" flex flex-col  rounded-xl border-2 border-brickly100 w-full  ">
          <div className="flex-col flex p-5  gap-5 ">
            ...
            <div className="h-20  border-b-2 border-b-brickly400/20">
              <div onClick={() => handleChecking(true)} className=" bg-brickly400 rounded-lg font-semibold hover:scale-[1.01] cursor-pointer transition-all py-3 text-center text-white ">Invertir ahora</div>
            </div>
      ...
      <div className="max-w-9xl py-5 px-20 flex gap-12 ">
        <div className="h-96  w-full flex">
          <div className="flex flex-col gap-10">
            ...
            <div className="flex gap-10">
              <div className="flex flex-col gap-5 ">
               {[["Precio minimo del token", "100U$D"], ["Rentabilidad  anual", "8,32%"], ["Inicio Renta", "30/09/2021"], ["Rentabilidad total", "7536.24"], ["Blockchain", "Polygon"]].map((item) => (
                 <div className="flex gap-2 items-end"><div className="text-gray-500 w-56">{item[0]}</div> <div className="font-bold  justify-end flex items-end w-32">{item[1]}</div></div>
               ) )}
              </div>

              <div className="flex flex-col gap-5 ">
               {[["Precio minimo del token", "100U$D"], ["Rentabilidad anual", "8,32%"], ["Inicio Renta", "30/09/2021"], ["Rentabilidad total", "7536.24"], ["Blockchain", "Polygon"]].map((item) => (
                 <div className="flex gap-2 items-end"><div className="text-gray-500 w-56 text-sm">{item[0]}</div> <div className="font-bold  justify-end flex items-end w-32">{item[1]}</div></div>
               ) )}
              </div>
            </div>
          </div>
        ...
        <div className="border-2 border-brickly100 w-full rounded-xl h-[300px] p-5 flex flex-col gap-5"> <div className=" text-sm text-gray-500">Calculadora retorno</div>
        
        <div className="flex flex-col gap-4 font-semibold">
        Inversión U$D:
        <input className="border px-4 py-1 bg-brickly100/50 font-semibold text-lg border-brickly100 rounded" placeholder="U$D" min={0} defaultValue={0} type="number"/>
        </div>
        <div className="flex flex-col gap-3">
          <div className="flex justify-end items-center">
          <div className="text-sm w-full">Ganancia total (5 años)</div>
          <div className="text-lg text-green-900 font-bold px-2">300U$D</div>
          </div>

          <div className="flex justify-end items-center">
          <div className="text-sm w-full">Ganancia anual</div>
          <div className="text-lg text-green-900 font-bold px-2">60U$D</div>
          </div>

          <div className="flex justify-end items-center">
          <div className="text-sm w-full">Monto final (Ganancia + Inversión)</div>
          <div className="text-base text-green-900 font-bold px-2">600U$D</div>
          </div>
        </div>
        </div>
      </div>
